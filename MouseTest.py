...
while True:
    for event in pygame.event.get():
        if event.type == QUIT:
            ...
            print "position:"+ str(mouse_x) + "  " + str(mouse_y)
            print "relative:" + str(move_x) +"   " + str(move_y)
    ...
    bn1,bn2,bn3 = pygame.mouse.get_pressed()
    print_text(font1,0,200,"Mouse Buttons:" + str(bn1) + "," + str(bn2) + "," + str(bn3))
